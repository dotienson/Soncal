          ...
          <form onSubmit={handleSubmit} className="p-4 space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full text-center tracking-[0.5em] font-mono text-2xl py-2.5 border rounded-xl outline-none transition-all ${error ? "border-red-400 focus:ring-red-500/20 text-red-600" : "border-slate-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 text-slate-800"}`}
                placeholder="••••"
                maxLength={6}
              />
              {error && (
                <p className="text-red-500 text-xs mt-1 text-center font-medium">
                  {type === "setup" || (type === "change" && step === "new")
                    ? "Mã PIN phải có ít nhất 4 số"
            ...
            <button
              type="submit"
              className={`w-full font-bold py-2.5 rounded-xl text-white shadow-md transition-transform active:scale-95 ${type === "setup" || (type === "change" && step === "new") ? "bg-amber-600 hover:bg-amber-700 shadow-amber-200" : "bg-blue-600 hover:bg-blue-700 shadow-blue-200"}`}
            >
              {type === "setup"
                ? "Lưu mã bí mật"
                : type === "verify"
